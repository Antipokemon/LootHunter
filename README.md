...
1. Run `/xlsettings`, open **Experimental → Custom Plugin Repositories**, and add these four URLs:
...
2. Save the settings.
3. Run `/xlplugins`, then install and enable **Lifestream**, **vnavmesh**, **Wrath Combo**, and **LootHunter**.
...
LootHunter uses unlocked aetherytes to travel, vnavmesh to move, and Wrath Combo to fight. Flight is optional under **Settings**.
